...
- ❌ **Desvantagem em testes de Intimidação** (presença pacífica)
- ❌ **-1d4 de dano** em ataques físicos (foco em suporte, não agressão)
- ❌ Não pode fazer **ataques de oportunidade** (filosofia defensiva)

## Estilo de Combate

Foco em suporte e cura. Harvest Clerics são a espinha dorsal do grupo, 
sacrificando poder ofensivo por capacidade de manter aliados vivos.
...
### **NÍVEL 1: TOQUE CURATIVO**
**Tipo:** Ação  
**Usos:** Proficiência + modificador de Sabedoria por descanso longo  
**Descrição:** Seu toque canaliza energia vital restauradora.

**[BASE - V1]:**  
Toque uma criatura. Ela recupera **2d8 + modificador de Sabedoria PV**. 

**[Evolução I - V2]:**  
Cura aumenta para **3d8 + modificador de Sabedoria**. Remove **1 condição** (envenenado, doente ou cego).
...
### **NÍVEL 3: AURA DE PROTEÇÃO**
**Tipo:** Ação Bônus  
**Usos:** 3x por descanso longo  
**Duração:** 1 minuto

**[BASE - V1]:**  
Você emana uma aura protetora. Aliados a até **3 metros** ganham **+2 CA**. 

**[Evolução I - V2]:**  
Bônus aumenta para **+3 CA**. Alcance aumenta para **4,5 metros**. 
...
**[BASE - V1]:**  
Toque um aliado morto (há no máximo 1 minuto). Ele retorna à vida com **1 PV**.

**[Evolução I - V2]:**  
O aliado retorna com **metade do PV máximo**. Pode ter morrido há até **10 minutos**. 
...
### **NÍVEL 9: BENÇÃO CRISTALINA**
**Tipo:** Ação  
**Usos:** 2x por descanso longo  
**Duração:** 1 hora

**[BASE - V1]:**  
Você abençoa até **3 aliados** que você possa ver a até **9 metros**. Eles ganham **+1d4 em jogadas de ataque** e **PV temporários igual ao seu nível**.

**[Evolução I - V2]:**  
Bônus aumenta para **+1d6**. PV temporários dobram. Afeta até **4 aliados**. 
...
### **NÍVEL 13: CÍRCULO DE CURA**
**Tipo:** Ação  
**Usos:** 1x por descanso longo

**[BASE - V1]:**  
Você cria um círculo de energia curativa de **6 metros de raio** centrado em você. Todos os aliados dentro recuperam **5d8 PV** imediatamente.

**[Evolução I - V2]:**  
Cura aumenta para **7d8 PV**. Raio aumenta para **9 metros**. O círculo permanece por **1 minuto** (aliados que entrarem curam 2d8 PV).
...
### **NÍVEL 17: SANTUÁRIO SAGRADO**
**Tipo:** Passiva  
**Descrição:** Você se torna um farol de proteção divina.

**[BASE - V1]:**  
Você ganha **resistência a dano necrótico e radiante**.  Quando um aliado a até **6 metros** cai a 0 PV, ele é **estabilizado automaticamente**.

**[Evolução I - V2]:**  
Resistência se torna **imunidade**.  Alcance aumenta para **9 metros**. Aliados estabilizados recuperam **1d8 PV**.

**[Evolução II - V4]:**  
Quando você usa magias de cura, cure **+1d8 PV adicional** por círculo da magia.  Alcance aumenta para **12 metros**.

**[Evolução III - V7]:**  
Bônus de cura aumenta para **+2d8 PV por círculo**.  Você ganha **regeneração de 1d8 PV** no início de cada turno.

**[FINAL - V10]:**  
Bônus de cura aumenta para **+3d8 PV por círculo**. Alcance aumenta para **18 metros**. Sua regeneração aumenta para **3d8 PV por turno**.  Quando você cairia a 0 PV, fica com **1 PV** em vez disso (1x por descanso longo, automático).

---

### **NÍVEL 20: RESSURREIÇÃO VERDADEIRA (ULTIMATE)**
**Tipo:** Ação  
**Usos:** 1x por dia

**[BASE - V1]:**  
Você traz um aliado morto de volta à vida, mesmo que tenha morrido há **100 anos**. Ele retorna com todo PV, sem penalidades. 

**[Evolução I - V2]:**  
O aliado retorna com todo PV e **imunidade a dano** por 1 hora. Membros perdidos são regenerados. Doenças/maldições são removidas.

**[Evolução II - V4]:**  
O aliado retorna **mais jovem** (até 20 anos a menos). Ganha **+2 em todos os atributos** por 24 horas.  Pode ter sido desintegrado ou morto por magias.

**[Evolução III - V7]:**  
Você pode ressuscitar **até 3 alvos** simultaneamente. Eles retornam no **auge físico** (idade ideal, sem cicatrizes). Ganham **vantagem em tudo** por 24 horas.
