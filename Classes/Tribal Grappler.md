...
- **[V1] Espírito Indomável (Passiva, Nível 1):**
  - Rubi concede vantagem em testes de Força e Atletismo.
  - Pode usar Força para testes de Intimidação em situações de confronto físico.

- **[V2] Grito de Guerra (Ação, Nível 2):**
  - 1x por descanso curto, Rubi pode inspirar aliados próximos (até 6m).
  - Todos aliados recebem bônus igual ao modificador de Constituição da Gema em testes de ataque e resistência até o início do próximo turno.

- **[V4] Chamado Cristalino (Ação Bônus, Nível 4):**
  - O portador pode chamar Rubi de volta instantaneamente, de qualquer distância.
  - Se inconsciente, Rubi retorna como arma.
  - Não pode voltar à forma humanoide até o próximo descanso curto.

- **[V7] Pele de Rubi (Reação, Nível 7):**
  - 1x por rodada, Rubi pode conceder resistência a dano físico para si ou um aliado adjacente até o início do próximo turno.
  - O valor da resistência é igual ao modificador de Constituição da Gema.

- **[V10] Avatar da Luta (Ultimate, Nível 10):**
  - Por 1 minuto, Rubi se torna um campeão colossal.
  - Todos aliados em até 9m recebem vantagem em testes de Força, Atletismo e resistência contra ser empurrado/agarrado.
  - O portador pode somar o modificador de Força da Gema ao dano de ataques desarmados durante a duração.

**Tipo de Arma:** Gauntlets/Garras

## Descrição

Lutadores de combate corpo a corpo puro usando gauntlets cristalinos. 
Especialistas em agarrões, socos devastadores e domínio físico total.
...
- ❌ **Alcance reduzido** (1,5 metros apenas, sem ataques à distância)
- ❌ **Desvantagem em testes de Prestidigitação** (mãos ocupadas)
- ❌ Não pode usar **ferramentas delicadas** (gazuas, ferramentas de ladrão, etc.)

## Estilo de Combate

Foco em combate de proximidade extrema e controle físico. Tribal Grapplers 
dominam oponentes através de força bruta e técnicas de luta, sacrificando 
...
### **NÍVEL 1: PUNHOS DE AÇO**
**Tipo:** Passiva  
**Descrição:** Seus golpes desarmados são armas letais.

**[BASE - V1]:**  
Seus ataques desarmados causam **1d8 + modificador de Força** de dano. Contam como mágicos.

**[Evolução I - V2]:**  
Dano aumenta para **1d10 + modificador de Força**. Você pode atacar **duas vezes** como ação (em vez de uma).
...
### **NÍVEL 3: AGARRÃO BRUTAL**
**Tipo:** Ação ou substituir ataque  
**Descrição:** Você domina oponentes com força esmagadora.

**[BASE - V1]:**  
Faça teste de Atletismo contra Atletismo ou Acrobacia do alvo. Sucesso: alvo fica **agarrado**. Enquanto agarrado, o alvo sofre **1d6 de dano** no início de cada turno dele.
...
### **NÍVEL 6: INVESTIDA FEROZ**
**Tipo:** Ação  
**Usos:** 3x por descanso curto

**[BASE - V1]:**  
Você corre até **9 metros** e faz um ataque desarmado com **+2d8 de dano**. Se acertar, empurra o alvo **3 metros**.

**[Evolução I - V2]:**  
Distância aumenta para **12 metros**. Dano adicional aumenta para **+3d8**. Alvo deve fazer teste de resistência de FOR (CD 8 + Prof + mod) ou cai no chão.

**[Evolução II - V4]:**  
Distância aumenta para **15 metros**. Dano adicional aumenta para **+4d8**. Você pode **atravessar** inimigos no caminho (todos sofrem 2d8 de dano).

**[Evolução III - V7]:**  
Distância aumenta para **18 metros**. Dano adicional aumenta para **+6d8**. Se o alvo colidir com parede/obstáculo, sofre **+3d8 de dano adicional** e fica **atordoado** por 1 turno.

**[FINAL - V10]:**  
Distância aumenta para **24 metros**. Dano adicional aumenta para **+8d8**. Você pode **agarrar automaticamente** o alvo ao acertar. Inimigos no caminho são **derrubados** e sofrem 4d8 de dano. Usos: **5x por descanso curto**.

---

### **NÍVEL 9: PELE DE PEDRA**
**Tipo:** Ação Bônus  
**Usos:** 3x por descanso longo  
**Duração:** 1 minuto

**[BASE - V1]:**  
Sua pele se endurece como rocha. Você ganha **resistência a dano físico** (corte, perfuração, contusão).
...
### **NÍVEL 17: FÚRIA INQUEBRÁVEL**
**Tipo:** Passiva  
**Descrição:** Você se torna uma força imparável.

**[BASE - V1]:**  
Quando chega a **metade do seu PV ou menos**, ganha **+2 de dano** em todos os ataques e **resistência a todos os danos**.
...
### **NÍVEL 20: TITÃ DE CRISTAL (ULTIMATE)**
**Tipo:** Ação  
**Usos:** 1x por dia  
**Duração:** 1 minuto
