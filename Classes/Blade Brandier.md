...
Espadachins mágicos que combinam técnica de lâmina com poder arcano.  
...
- ❌ **Desvantagem em testes de Força (Atletismo)** brutos
- ❌ **-1d4 de dano** contra inimigos com **resistência a magia**
- ❌ Requer **mão livre** para gestos somáticos (não pode usar escudo efetivamente)
...
### **NÍVEL 1: LÂMINA ARCANA**
**Tipo:** Passiva  
**Descrição:** Sua espada canaliza energia mágica a cada golpe.

**[BASE - V1]:**  
Seus ataques corpo a corpo adicionam **+1d6 de dano elemental** (escolha: fogo, gelo, elétrico ou energia).

**[Evolução I - V2]:**  
Dano adicional aumenta para **+1d8**. Você pode mudar o tipo de dano como **ação bônus**. 
...
### **NÍVEL 3: CONTRA-FEITIÇO ELEGANTE**
**Tipo:** Reação  
**Usos:** 2x por descanso curto

**[BASE - V1]:**  
Quando uma criatura lança uma magia que você possa ver a até **18 metros**, você pode fazer um **corte dimensional** para interrompê-la. Faça teste de Arcanismo (CD 10 + círculo da magia). Sucesso: a magia é cancelada. 

**[Evolução I - V2]:**  
Você tem **vantagem** no teste. Alcance aumenta para **24 metros**. Usos: **3x por descanso curto**.

**[Evolução II - V4]:**  
Você **automaticamente** cancela magias de **3º círculo ou inferior**. Para magias maiores, teste com vantagem.
...
### **NÍVEL 6: ESTOCADA ARCANA**
**Tipo:** Ação  
**Usos:** 2x por descanso curto

**[BASE - V1]:**  
Você faz uma investida mágica.  Teleporte até **9 metros** até um inimigo que você possa ver e faça um ataque corpo a corpo com **+3d8 de dano de energia**. 

**[Evolução I - V2]:**  
Distância aumenta para **12 metros**. Dano adicional aumenta para **+4d8**. O alvo deve fazer teste de resistência de CON (CD 8 + Prof + mod) ou fica **atordoado** até o fim do próximo turno.
...
### **NÍVEL 9: BARREIRA ARCANA**
**Tipo:** Reação  
**Usos:** 3x por descanso longo

**[BASE - V1]:**  
Quando você ou um aliado a até **6 metros** sofrer dano, você ergue uma barreira mágica que absorve até **3d10 de dano**.

**[Evolução I - V2]:**  
Absorve até **5d10 de dano**. Alcance aumenta para **9 metros**. A barreira dura até o início do seu próximo turno.
...
### **NÍVEL 13: TEMPESTADE DE LÂMINAS**
**Tipo:** Ação  
**Usos:** 1x por descanso longo

**[BASE - V1]:**  
Você cria cópias mágicas da sua lâmina que atacam tudo ao redor. Todos os inimigos a até **6 metros** sofrem **5d8 de dano de energia** (teste de resistência de DES CD 8 + Prof + mod para metade).

**[Evolução I - V2]:**  
Alcance aumenta para **9 metros**. Dano aumenta para **7d8**. Você pode **escolher** quais criaturas são afetadas (pode poupar aliados).
...
**Tipo:** Passiva  
**Descrição:** Você dominou perfeitamente a fusão de magia e espada. 

**[BASE - V1]:**  
Você ganha **+2 CA permanente**.  Você tem **vantagem em testes de resistência contra magias**. 

**[Evolução I - V2]:**  
CA aumenta para **+3**.  Você ganha **resistência a dano elemental** (fogo, gelo, elétrico, ácido, trovão).
...
### **NÍVEL 20: CORTE DIMENSIONAL (ULTIMATE)**
**Tipo:** Ação  
**Usos:** 1x por dia

**[BASE - V1]:**  
Você rasga a realidade com sua lâmina. Faça um ataque em linha reta de **30 metros**. Todos no caminho sofrem **15d10 de dano de energia** (teste de resistência de DES CD 20 para metade). Abre um **portal dimensional** no local.

**[Evolução I - V2]:**  
Distância aumenta para **45 metros**. Dano aumenta para **18d10**. O portal permite **teleporte** entre dois pontos que você marcar por **1 hora**.
